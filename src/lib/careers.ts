...
export const CAREER_ROLES: CareerRole[] = [
  {
    ...
    rateLabel: "$100–$130/hr + commission",
    compensation: "$100 – $130 USD / hour + commission",
    compensationNote: "Commission on closed business, in addition to the hourly rate",
    location: "Remote",
  ...
  },
  {
    ...
    rateLabel: "$100–$130/hr",
    compensation: "$100 – $130 USD / hour",
  ...
  },
  {
    ...
    rateLabel: "$110–$150/hr",
    compensation: "$110 – $150 USD / hour",
  ...
  },
  {
    ...
    rateLabel: "$130–$175/hr",
    compensation: "$130 – $175 USD / hour",
  ...
  },
  {
    ...
    rateLabel: "$115–$150/hr",
    compensation: "$115 – $150 USD / hour",
    compensationNote: "Depending on experience. Open to a longer collaboration after the first engagement",
    location: "Remote",
    engagement: ENGAGEMENT,
    whyJoin: WHY_ENGINEERING,
  ...
  },
  {
    ...
    rateLabel: "$125–$165/hr",
    compensation: "$125 – $165 USD / hour",
    compensationNote: "Depending on experience. Open to a longer collaboration after the first engagement",
    location: "Remote",
    engagement: ENGAGEMENT,
    whyJoin: WHY_ENGINEERING,
  ...
  },
  {
    ...
    rateLabel: "$160–$220/hr",
    compensation: "$160 – $220 USD / hour",
  ...
  },
  {
    ...
    rateLabel: "$175–$250/hr + PnL share",
    compensation: "$175 – $250 USD / hour + PnL share",
    compensationNote: "PnL share typically 10–25%, depending on mandate and structure",
    location: "Remote",
    engagement: ENGAGEMENT,
    whyJoin: WHY_ENGINEERING,
    hiringSteps: engineeringSteps(
