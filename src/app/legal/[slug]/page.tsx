...
const DOCS: Record<string, { title: string; intro: string; body: string[] }> = {
  terms: {
    ...
    intro:
      "These terms govern your use of the Orveliant website. This is a Phase 1 informational site; full platform terms will be provided at account activation.",
    body: [
      ...
      "5. Intellectual property. The Orveliant name, logo, visual assets, and site content are owned by Orveliant and may not be copied or reused without permission.",
      ...
      "7. Limitation of liability. To the maximum extent permitted by law, Orveliant is not liable for any loss arising from your use of, or reliance on, this website.",
  ...
  privacy: {
    ...
    body: [
      ...
      "2. How we use it. To contact you about Orveliant, respond to enquiries, plan onboarding, and improve our services. We process this information based on your consent and our legitimate interest in operating the business.",
      ...
      "6. Your rights. You may request access to, correction of, or deletion of your personal information, and you may unsubscribe at any time. Contact contact@orveliant.com.",
  ...
  risk: {
    ...
    intro:
      "Please read this disclosure carefully before considering any Orveliant strategy.",
    body: [
  ...
  cookies: {
    title: "Cookie Policy",
    intro:
      "This policy explains how Orveliant uses cookies and similar technologies on this website.",
    body: [
